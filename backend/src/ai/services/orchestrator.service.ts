...
import { AIRequest, AIResponse, AgentType } from "../models/types";
import { documentGeneratorAgent } from "../agents/documentGenerator.agent";
import { legalSearchAgent } from "../legal-search/legalSearch.agent";
