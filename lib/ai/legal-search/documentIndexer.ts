...
import { vectorStoreService } from "@/lib/ai/legal-search/vectorStoreService";
import { pdfLoaderService } from "@/lib/ai/legal-search/pdfLoaderService";

const LEGAL_LIBRARY_DIR = path.resolve(process.cwd(), "legal_library");
const META_DIR = path.resolve(process.cwd(), "ai_data/legal_search");
